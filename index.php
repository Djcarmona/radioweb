<!DOCTYPE html>
        ...
        <head>
            ...
            <meta name="theme-color" content="#f3123f">
            <title>Radio</title>
            <!-- bootstrap css -->
        ...
        <div id="loading-page-bb" style="opacity: 0; height: 100%;">
              <div class="meu_card" id="contato"  style="width:98%; margin:2px; padding: 5px; border-radius: 5px; box-shadow: 7px 7px 13px 0px rgba(50, 50, 50, 0.22);">
    <span class="meu_texto" id="contato_txt" style="font-size: 18px; color: #ffffff; font-weight: bold; ">Whatsapp</span>
    <img src="assets/whats.png" height="20px" width="20px" id="whats_img">
  </div>



  <div id="cabecalho" class="classe_da_tela" style="background-color: #ffffff; height: auto; width: 100%;">
    <img src="assets/logo.png" height="50px" width="auto" id="img_logo">
  </div>
  <audio id="player" src="http://s5.myradiostream.com:42988/stream" controls></audio>
  <div id="controles" class="classe_da_tela" style="background-color: #ffffff; height: 100px; width: auto;">
    <img src="assets/play.png" height="auto" width="auto" id="play_btn">
  </div>
